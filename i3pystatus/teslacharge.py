...
class TeslaCharge(IntervalModule):
    ...
    format_without_charge = (
        "{name}: {battery_level}%/{charge_limit_soc}% ({battery_range})"
    )
    ...
    def run(self):
        ...
        if thisvehicle.state != "online":
            ...
            cdict = {
                ...
                "charge_port_cold_weather_mode": charge_info[
                ...
                "managed_charging_start_time": charge_info[
                    "managed_charging_start_time"
                ],
                "managed_charging_user_canceled": charge_info[
                ...
                "scheduled_charging_start_time": charge_info[
